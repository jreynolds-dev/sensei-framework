...
2. **Read** `PROGRESS.md` and `ROADMAP.md`. If `PROGRESS.md` does not exist, create it first using the Progress Tracking Protocol format from the framework -- derive domains from `ROADMAP.md` stages.
